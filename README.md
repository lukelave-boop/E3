...
reference**. **Position probe** becomes **Move probe here** after a valid camera
...
This is a desktop change; installed firmware, Pi software and saved teaching
are unchanged. See [the focus guide](docs/LASER_FOCUS.md).
