...
layer without creating a separate per-object display color. File import commands
are grouped under **File > Import** while retaining their existing actions and
shortcuts.
...
at 4× internal resolution with physical cleanup/smoothing/error controls;
straight spans persist as lines, curved spans persist as cubic Béziers, and
