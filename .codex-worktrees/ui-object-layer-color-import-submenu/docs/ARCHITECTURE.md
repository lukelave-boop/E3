...
permits and otherwise fitted with bounded cubic Béziers. Those fitted segments
become the native persisted subpath. A separate adaptive flattening using the
