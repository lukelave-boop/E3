...
hard corners must persist across two contour scales, raster stair steps are not
locked as corners, straight spans persist as lines, and non-corner cubic spans
share tangent-continuous joins. Nested holes remain separate closed child
subpaths. Preview/topology samples are
