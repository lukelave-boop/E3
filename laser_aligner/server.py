...
class AppRequestHandler(BaseHTTPRequestHandler):
    ...
    def _reject_request(self, status: HTTPStatus, message: str) -> None:
        ...
        # parsed as a subsequent request. Drain only a single, bounded,
        # unambiguously framed body first: Windows otherwise resets a socket
        # that is closed with unread receive data, which can discard the JSON
        # error response before the local client receives it.
        self.close_connection = True
