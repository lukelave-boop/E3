...
#define E3_BOARD_ID UINT32_C(0x0103E013)
#define E3_IMAGE_VERSION UINT32_C(1)
#define E3_HEADER_ADDRESS UINT32_C(0x08010000)
#define E3_HEADER_SIZE UINT32_C(512)
#define E3_PAYLOAD_ADDRESS UINT32_C(0x08010200)
#define E3_PAYLOAD_CAPACITY UINT32_C(0x0006FE00)
/* ST's application startup reserves entries through its BootRAM word at 0x1E0. */
#define E3_VECTOR_SIZE UINT32_C(484)
#define E3_PAYLOAD_MINIMUM UINT32_C(488)
