"""Execute actual patched Marlin G39/probe functions on an emulated Cortex-M3."""
...
def run(source: Path, toolchain: Path) -> None:
    ...
    for total, extra in ((2, 0), (3, 0), (3, 1)):
        ...
        subprocess.run([str(compiler), "-mcpu=cortex-m3", "-mthumb", "-mfloat-abi=soft",
        ...
        print(f"Production G39/probe Cortex-M3 tests passed, TOTAL_PROBING={total}, EXTRA={extra}; fake I/O.")
